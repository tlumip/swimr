...
ref_db <- "~/Documents/projects/swim/AA_Decay_TravelCost.db" # reference
cur_db <- "~/Documents/projects/swim/AA_Decay_TravelCost_2xPDX.db" # current
...
Congestion is defined as having a peak period volume 1.2 times greater than the
link capacity. These plots show show the percent of PM period VMT travelling on
such links in the region.
...
compare_tlfd(db1, db2, facet, facet_levels, bin_width = 1, max_bin = 30)
```
...
```{r compare_logsum, fig.cap = "Mode choice model logsums - all MPO's"}
