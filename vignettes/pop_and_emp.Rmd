...
```{r two_scenarios}
db1 <- src_sqlite("~/Documents/projects/swim/midjuly_swim.db")
db2 <- src_sqlite("~/Documents/projects/swim/FinalReference_Test.db")
```

```{r compare_floorspace}
compare_floorspace(db1, db2, facet_var = "COUNTY", 
                   facet_levels = c("Multnomah", "Clackamas", "Washington"))
```

```{r compare_sedata}
compare_sevar(db1, db2, facet_var = "COUNTY", 
              facet_levels = c("Multnomah", "Clackamas", "Washington"))
```
